...
data_set_path = r"../bughouse/data/pairs_dataset_2005nz.csv"
...
finder = Chef(train_loader, test_loader, optimizer={"AdaDelta": optim.Adadelta}, batch_size=batch_size, epoch=5,
              input_size=84)
...
finder.set_features_size_list([ 84*2,256,512])
finder.set_network_length(9)
finder.use_gpu()
